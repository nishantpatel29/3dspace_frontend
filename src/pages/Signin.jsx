    ...
    <div className="pt-16 min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Sign in to your DesignSpace 3D account</p>
        </div>
        ...
        <Card className="glass-panel glow-green">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-center">
              <p className="text-gray-400">Don't have an account? <a href="#signup" className="text-green-400 hover:text-green-300 font-medium">Sign up</a></p>
            </div>
          </CardContent>
        </Card>
      </div>
